...
"""
Contains all Empirical DEB entry points

source: AmP => 

CURRENT OVERVIEW:

/taxon registry/species_name.py

## DEB KERNEL VERSION ID

CURRENTLY DYNAMIC ______________________________________________________________________
1. Identity / model metadata
2. Feeding / assimilation anchors
3. Reserve mobilisation / allocation
4. 
...
CURRENT CONSTANTS __________________________________________________________________________
